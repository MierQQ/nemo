...
final class Module_grammar2code {
	...
	Module_grammar2code(Parser runtime) {
	...
	Struct_Pair f_grammar2code(Struct_Grammar ag) {
		...
		final Func3<Struct_Pair,Integer, Struct_Pair, Struct_Production> l5_$0 = new Func3<Struct_Pair,Integer,Struct_Pair,Struct_Production>() {
			final public Struct_Pair invoke(final Integer ai, final Struct_Pair aacc, final Struct_Production ap) {
				final Object[] l6_c = f_production2code(l6_g, ap);
				return (new Struct_Pair(runtime.h_Native.concat(((Object[])aacc.f_first), l6_c), ((Func3<Struct,Struct, Integer, Integer>)(Func3)runtime.n_setTree).invoke(((Struct)aacc.f_second), ai, ((Integer)runtime.h_Native.length(((Object[])aacc.f_first))))));
			}
		};
							...
							if (((Object[])aacc).length == 0) {
								...
								if ((runtime.h_Native.length(ac)==1)) {
									...
									case 80/*PegString*/: {
										...
										return runtime.h_Native.concat((new Object[] { (new Struct_PegStringChoice(l29_s, (runtime.h_Native.length(aacc)+1))) }), aacc);
									}
									case 71/*PegRange*/: {
										...
										return runtime.h_Native.concat((new Object[] { (new Struct_PegRangeChoice(l32_low, l33_up, (runtime.h_Native.length(aacc)+1))) }), aacc);
									}
									default: {
										return runtime.m_array.f_concat3((new Object[] { (new Struct_PegChoice((runtime.h_Native.length(ac)+2))) }), ac, runtime.h_Native.concat((new Object[] { (new Struct_PegCommit((runtime.h_Native.length(aacc)+1))) }), aacc));
									}
