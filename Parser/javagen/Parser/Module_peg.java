...
final class Module_peg {
	...
	String f_action2string(Struct aa) {
		...
		case 4/*ActionConstantInt*/: {
			...
			return runtime.n_i2s.invoke(((Integer)l15_i));
		}
		default:
	...
	Struct f_convertNestedSequence(Struct_Production aprod, Struct apar, Reference<Integer> anextFree, Reference<Object[]> aextraProductions) {
		...
		case 97/*Seq*/: {
			...
			if ((runtime.h_Native.length(l48_sequence)==1)) {
				...
				final Struct_Production l50_production = (new Struct_Production(((aprod.f_name+"$auto")+runtime.n_i2s.invoke(((Integer)l49_n))), false, ((Struct)SingletonStructs.str_PegUnknown), (new Object[] { (new Struct_Seq(l48_sequence)) })));
		...
		if (false) {
			...
			final Func1<Struct_Production,Struct_Production> l3_$0 = new Func1<Struct_Production,Struct_Production>() {
				final public Struct_Production invoke(final Struct_Production ap) {
					...
					final Func1<Struct_Seq,Struct_Seq> l13_$4 = new Func1<Struct_Seq,Struct_Seq>() {
						final public Struct_Seq invoke(final Struct_Seq ac) {
							return (new Struct_Seq(f_inlineParsingSequence(l4_g, ac.f_seq)));
						}
					};
					return (new Struct_Production(l9_$6, l10_$7, l11_$8, runtime.h_Native.map(l12_$5, ((Func1<Object,Object>)(Func1)l13_$4))));
				}
			};
	...
	Struct_Grammar f_processNestedSequences(Struct_Grammar ag) {
		...
		final Func1<Struct_Production,Struct_Production> l5_$2 = new Func1<Struct_Production,Struct_Production>() {
			final public Struct_Production invoke(final Struct_Production ap) {
				...
				final Func1<Struct_Seq,Struct_Seq> l15_$6 = new Func1<Struct_Seq,Struct_Seq>() {
					final public Struct_Seq invoke(final Struct_Seq ac) {
						final Object[] l18_$17 = ac.f_seq;
						final Func1<Struct,Struct> l19_$16 = new Func1<Struct,Struct>() {
							final public Struct invoke(final Struct apar) {
								return f_convertNestedSequence(ap, apar, l0_nextFree, l1_extraProductions);
							}
						};
						return (new Struct_Seq(runtime.h_Native.map(l18_$17, ((Func1<Object,Object>)(Func1)l19_$16))));
					}
				};
				return (new Struct_Production(l11_$8, l12_$9, l13_$10, runtime.h_Native.map(l14_$7, ((Func1<Object,Object>)(Func1)l15_$6))));
			}
		};
