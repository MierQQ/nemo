...
final class Module_math {
	...
	Module_math(Parser runtime) {
		this.runtime = runtime;
	}
	double nf_i2d(int ai) {
		return ((double)ai);
	}
	...
	int f_floor(double ad) {
		return ((int)runtime.n_trunc.invoke(((Double)((ad>=0.0)?ad:((((-ad)-((double)runtime.n_i2d.invoke(runtime.n_trunc.invoke(((Double)(-ad))))))>0.0)?(ad-1.0):ad)))));
	}
	...
	Struct_Pair f_s2dfrac(String as, int ai, int an, double aacc, double afracacc) {
		if ((ai<an)) {
			...
			if ((l1_d!=(-1))) {
				final Struct_Pair l2_fracres = f_s2dfrac(as, (ai+1), an, ((aacc*10.0)+((double)runtime.n_i2d.invoke(((Integer)l1_d)))), (afracacc*10.0));
			...
			if ((l1_d!=(-1))) {
				{
					...
					final double l3___tmp = ((10.0*aacc)+((double)runtime.n_i2d.invoke(((Integer)l1_d))));
					ai = l2___tmp;
					aacc = l3___tmp;
					continue TAIL_CALL;
				}
