...
final class Module_pegcode {
	...
	String f_pegcode2string(int apc, Struct ac, Func1<String,Integer> afn) {
		...
		case 81/*PegStringChoice*/: {
			...
			return (((((("PegStringChoice("+((Func1<String,String>)(Func1)runtime.gfw_toString).invoke(l4_x))+", ")+runtime.n_i2s.invoke(((Integer)l5_d)))+" -> ")+runtime.n_i2s.invoke(((Integer)(apc+l5_d))))+")");
		}
		case 72/*PegRangeChoice*/: {
			...
			return (((((((("PegRangeChoice("+((Func1<String,String>)(Func1)runtime.gfw_toString).invoke(l9_low))+", ")+((Func1<String,String>)(Func1)runtime.gfw_toString).invoke(l10_up))+", ")+runtime.n_i2s.invoke(((Integer)l11_d)))+" -> ")+runtime.n_i2s.invoke(((Integer)(apc+l11_d))))+")");
		}
		case 59/*PegChoice*/: {
			final Struct_PegChoice l1__tmp = (Struct_PegChoice)l0__tmp;
			final int l12_d = l1__tmp.f_l;
			final int l13_d = l1__tmp.f_l;
			return (((("PegChoice(+"+runtime.n_i2s.invoke(((Integer)l13_d)))+" -> ")+runtime.n_i2s.invoke(((Integer)(apc+l13_d))))+")");
		}
		case 62/*PegCommit*/: {
			final Struct_PegCommit l1__tmp = (Struct_PegCommit)l0__tmp;
			final int l14_d = l1__tmp.f_l;
			final int l15_d = l1__tmp.f_l;
			return (((("PegCommit(+"+runtime.n_i2s.invoke(((Integer)l15_d)))+" -> ")+runtime.n_i2s.invoke(((Integer)(apc+l15_d))))+")");
		}
		case 55/*PegCall*/: {
			final Struct_PegCall l1__tmp = (Struct_PegCall)l0__tmp;
			final int l16_d = l1__tmp.f_l;
			final int l17_d = l1__tmp.f_l;
			return (((("PegCall("+runtime.n_i2s.invoke(((Integer)l17_d)))+" : ")+afn.invoke(((Integer)l17_d)))+")");
		}
		case 54/*PegCacheCall*/: {
			...
			return (((((("PegCacheCall("+runtime.n_i2s.invoke(((Integer)l20_d)))+" : ")+afn.invoke(((Integer)l20_d)))+",")+runtime.n_i2s.invoke(((Integer)l21_ce)))+")");
		}
		default: {
	...
	Object f_printPegcode(Object[] aop, Struct adebug) {
		...
		final Func1<String,Integer> l0_fn = new Func1<String,Integer>() {
			final public String invoke(final Integer apc) {
				...
				return ((String)runtime.m_tree.f_foldTree(l1_debug, "", ((Func3<Object,Object, Object, Object>)(Func3)l2_$1)));
			}
		};
		...
		final Func3<Struct,Integer, Struct, Struct> l5_$2 = new Func3<Struct,Integer,Struct,Struct>() {
			final public Struct invoke(final Integer ai, final Struct aacc, final Struct ac) {
				...
				final int l7_prof = ((int)runtime.m_tree.f_lookupTreeDef(g_profilePcs.value, ai, 0));
				return ((Func3<Struct,Struct, String, Integer>)(Func3)runtime.n_setTree).invoke(aacc, l6_fun, ((Integer)(((int)runtime.m_tree.f_lookupTreeDef(aacc, l6_fun, 0))+l7_prof)));
			}
		};
		...
		if ((l7_total!=0)) {
			...
			final Func2<Object,String, Integer> l9_$8 = new Func2<Object,String,Integer>() {
				final public Object invoke(final String ak, final Integer av) {
					if ((((int)av)>0)) {
						return runtime.m_runtime.f_println((((((ak+": ")+runtime.n_i2s.invoke(av))+" ")+runtime.m_stringmath.f_d2st(((100.0*((double)runtime.n_i2d.invoke(av)))/((double)runtime.n_i2d.invoke(((Integer)l7_total)))), 1))+"%"));
					} else {
						return null;
					}
				}
			...
			final Func3<Struct,Integer, Struct, Struct> l13_$10 = new Func3<Struct,Integer,Struct,Struct>() {
				final public Struct invoke(final Integer ai, final Struct aacc, final Struct ac) {
					final int l14_prof = ((int)runtime.m_tree.f_lookupTreeDef(g_profilePcs.value, ai, 0));
					return ((Func3<Struct,Struct, String, Integer>)(Func3)runtime.n_setTree).invoke(aacc, ((Struct)ac).getTypeName(), ((Integer)(((int)runtime.m_tree.f_lookupTreeDef(aacc, ((Struct)ac).getTypeName(), 0))+l14_prof)));
				}
			};
			final Struct l14_perOpcode = ((Struct)runtime.h_Native.foldi(aop, l12_$11, ((Func3<Object,Integer, Object, Object>)(Func3)l13_$10)));
			runtime.m_runtime.f_println(("\nInstructions per opcode. Total: "+runtime.n_i2s.invoke(((Integer)l7_total))));
		...
		final Func3<String,Integer, String, Struct> l18_$17 = new Func3<String,Integer,String,Struct>() {
			final public String invoke(final Integer ai, final String aacc, final Struct ac) {
				final int l19_prof = ((int)runtime.m_tree.f_lookupTreeDef(g_profilePcs.value, ai, 0));
				return ((((((aacc+runtime.n_i2s.invoke(ai))+" ")+l0_fn.invoke(ai))+":")+f_pegcode2string(((int)ai), ac, l0_fn))+((l7_total!=0)?((" "+runtime.n_i2s.invoke(((Integer)l19_prof)))+" visits\n"):"\n"));
			}
		};
	...
	Struct_ParseResult f_runPeg(String ainput, Object[] aprogram, Struct adebug, Struct_SemanticActions afunctions) {
		...
		final Func1<Object,Object[]> l3_$0 = new Func1<Object,Object[]>() {
			final public Object invoke(final Object[] aargs) {
				final int l4_pc = runtime.m_dynamic.f_flow2i(((Object)(aargs[0])));
				final Func3<String,Integer, String, String> l6_$5 = new Func3<String,Integer,String,String>() {
					final public String invoke(final Integer ak, final String av, final String aacc) {
						if ((l4_pc>=((int)ak))) {
							return av;
						} else {
				...
				return runtime.m_dynamic.f_flow(runtime.m_tree.f_foldTree(l4_debug, "", ((Func3<Object,Object, Object, Object>)(Func3)l6_$5)));
			}
		};
		...
		final Func2<Integer,Integer, Struct> l7_$6 = new Func2<Integer,Integer,Struct>() {
			final public Integer invoke(final Integer aacc, final Struct aop) {
				...
				case 54/*PegCacheCall*/: {
					...
					return ((Func2<Integer,Integer, Integer>)(Func2)runtime.n_max).invoke(aacc, ((Integer)l13_c));
				}
				default: {
					return aacc;
				}
		...
		if ((l16_r.f_pos<runtime.h_Native.strlen(ainput))) {
			...
			final Func2<Integer,Integer, Reference<Struct>> l22_$17 = new Func2<Integer,Integer,Reference<Struct>>() {
				final public Integer invoke(final Integer aacc, final Reference<Struct> atheCache) {
					...
					final Func2<Object,Integer, Struct_PegVmCacheItem> l25_$24 = new Func2<Object,Integer,Struct_PegVmCacheItem>() {
						final public Object invoke(final Integer ap, final Struct_PegVmCacheItem as) {
							if ((!FlowRuntime.compareEqual(as,runtime.m_pegcode_lib.g_peg_fail_cache_item))) {
								l23_pos.value = ((Func2<Integer,Integer, Integer>)(Func2)runtime.n_max).invoke(ap, l23_pos.value);
								return null;
							} else {
								return null;
							}
					...
					runtime.m_inttree.f_iterIntTree(atheCache, ((Func2<Object,Integer, Object>)(Func2)l25_$24));
		...
		if ((apc<0)) {
				...
				case 15/*Cons*/: {
					...
					case 76/*PegStackPc*/: {
						...
						final Struct l112_tl = l108__tmp.f_capture;
						{
							...
							final Struct l115___tmp = (new Struct_Cons(((Func2<Struct,Struct, Struct>)(Func2)runtime.n_headList).invoke(acapture, apca.f_capture), l112_tl));
							final Struct l116___tmp = runtime.n_tailList.invoke(aenv);
							apc = l113___tmp;
							astack = l114___tmp;
							acapture = l115___tmp;
							aenv = l116___tmp;
					...
					case 77/*PegStackPcCache*/: {
						...
						final Struct l125_res = ((Func2<Struct,Struct, Struct>)(Func2)runtime.n_headList).invoke(acapture, apca.f_capture);
						...
						case 95/*RuleResult*/: {
							...
							l133_it.value = runtime.m_inttree.f_addOrUpdateIntTree(l133_it, l123_si, (new Struct_PegVmCacheItem(ai, l127__tmp)));
							break;
						}
						default: {
							break;
						...
						}
						{
							...
							final Struct l137___tmp = runtime.n_tailList.invoke(aenv);
							apc = l134___tmp;
							astack = l135___tmp;
							acapture = l136___tmp;
							aenv = l137___tmp;
			...
			case 64/*PegDrop*/: {
				{
					...
					final Struct l146___tmp = runtime.n_tailList.invoke(acapture);
					apc = l145___tmp;
					acapture = l146___tmp;
					continue TAIL_CALL;
				}
			...
			case 62/*PegCommit*/: {
				...
				final int l148_l = l39__tmp.f_l;
				{
					...
					final Struct l150___tmp = runtime.n_tailList.invoke(astack);
					apc = l149___tmp;
					astack = l150___tmp;
					continue TAIL_CALL;
				}
			}
			case 79/*PegStartString*/: {
				{
			...
			case 51/*PegBindString*/: {
				...
				case 15/*Cons*/: {
					...
					case 58/*PegCaptureStringStart*/: {
						...
						final Struct_RuleResult l167_rr = (new Struct_RuleResult(runtime.m_dynamic.f_flow(apca.f_input), l166_s, (ai-l166_s), (new Struct_Some(runtime.m_dynamic.f_flow(runtime.h_Native.substring(apca.f_input, l166_s, (ai-l166_s)))))));
						final Struct l168_tenv = ((Func2<Struct,Struct, Struct>)(Func2)runtime.n_headList).invoke(aenv, runtime.m_tree.f_makeTree());
						final Struct_Cons l169_nenv = (new Struct_Cons(((Func3<Struct,Struct, String, Struct_RuleResult>)(Func3)runtime.n_setTree).invoke(l168_tenv, l154_v, l167_rr), runtime.n_tailList.invoke(aenv)));
						{
			...
			case 52/*PegBindValue*/: {
				...
				final Struct_RuleResult l192_rr = (new Struct_RuleResult(runtime.m_dynamic.f_flow(apca.f_input), ai, runtime.h_Native.strlen(apca.f_input), l178_result));
				final Struct l193_tenv = ((Func2<Struct,Struct, Struct>)(Func2)runtime.n_headList).invoke(aenv, runtime.m_tree.f_makeTree());
				final Struct_Cons l194_nenv = (new Struct_Cons(((Func3<Struct,Struct, String, Struct_RuleResult>)(Func3)runtime.n_setTree).invoke(l193_tenv, l177_v, l192_rr), runtime.n_tailList.invoke(aenv)));
				{
			...
			case 50/*PegBindIndex*/: {
				...
				final Struct_RuleResult l199_rr = (new Struct_RuleResult(runtime.m_dynamic.f_flow(apca.f_input), ai, 0, (new Struct_Some(runtime.m_dynamic.f_flow(ai)))));
				final Struct l200_tenv = ((Func2<Struct,Struct, Struct>)(Func2)runtime.n_headList).invoke(aenv, runtime.m_tree.f_makeTree());
				final Struct_Cons l201_nenv = (new Struct_Cons(((Func3<Struct,Struct, String, Struct_RuleResult>)(Func3)runtime.n_setTree).invoke(l200_tenv, l198_v, l199_rr), runtime.n_tailList.invoke(aenv)));
				{
			...
			case 46/*PegAction*/: {
				...
				final Object l206_v = l205_fn.invoke((new Struct_PegEnv(((Func2<Struct,Struct, Struct>)(Func2)runtime.n_headList).invoke(aenv, runtime.m_tree.f_makeTree()), apca.f_fns)));
				final Struct_RuleResult l207_rr = (new Struct_RuleResult(runtime.m_dynamic.f_flow(apca.f_input), ai, 0, (new Struct_Some(l206_v))));
				{
			...
			case 47/*PegAction2*/: {
				...
				final Object l212_v = runtime.m_pegcode_lib.f_evalActionExp(l211_e, ai, ((Func2<Struct,Struct, Struct>)(Func2)runtime.n_headList).invoke(aenv, runtime.m_tree.f_makeTree()), apca.f_fns);
				final Struct_RuleResult l213_rr = (new Struct_RuleResult(runtime.m_dynamic.f_flow(apca.f_input), ai, 0, (new Struct_Some(l212_v))));
				{
			...
			case 48/*PegActionIndex*/: {
				final Struct_RuleResult l216_rr = (new Struct_RuleResult(runtime.m_dynamic.f_flow(apca.f_input), ai, 0, (new Struct_Some(runtime.m_dynamic.f_flow(ai)))));
				{
			...
			case 56/*PegCaptureList*/: {
				final Struct_Pair l220_listAndRest = runtime.m_pegcode_lib.f_grabUntilMarker(runtime.m_list.f_makeList(), acapture);
				final Struct l224_$222 = ((Struct)l220_listAndRest.f_first);
				final Struct l225_$223 = runtime.m_list.f_makeList();
				final Func2<Struct,Struct, Struct> l226_$221 = new Func2<Struct,Struct,Struct>() {
				...
				final Struct l227_results0 = ((Struct)runtime.m_list.f_foldList(l224_$222, l225_$223, ((Func2<Object,Object, Object>)(Func2)l226_$221)));
				final Object[] l228_results = runtime.h_Native.list2array(l227_results0);
				final Struct_RuleResult l229_rr = (new Struct_RuleResult(runtime.m_dynamic.f_flow(apca.f_input), ai, runtime.h_Native.strlen(apca.f_input), (new Struct_Some(runtime.m_dynamic.f_flow(l228_results)))));
				{
			...
			case 60/*PegClearCache*/: {
				final Object[] l234_$233 = apca.f_cache.f_caches;
				final Func1<Object,Reference<Struct>> l235_$232 = new Func1<Object,Reference<Struct>>() {
					final public Object invoke(final Reference<Struct> ac) {
						ac.value = runtime.m_inttree.f_makeIntTree().value;
						return null;
					}
				};
				runtime.h_Native.iter(l234_$233, ((Func1<Object,Object>)(Func1)l235_$232));
				{
