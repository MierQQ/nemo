...
final class Module_rename_bindings {
	...
	Module_rename_bindings(Parser runtime) {
	...
	Struct_Seq f_renameBindingsInChoice(Struct_Seq ac) {
		...
		final Func2<Struct_Pair,Struct_Pair, Struct> l5_$0 = new Func2<Struct_Pair,Struct_Pair,Struct>() {
			final public Struct_Pair invoke(final Struct_Pair aacc, final Struct ap) {
				final Struct_Pair l6_r = f_renameBindingsInParsing(ap, ((Struct)aacc.f_second));
				return (new Struct_Pair(runtime.m_array.f_arrayPush(((Object[])aacc.f_first), l6_r.f_first), l6_r.f_second));
			}
		};
	...
	Struct_Pair f_renameBindingsInParsing(Struct apar, Struct arenamings) {
		...
		case 12/*BindResult*/: {
			...
			final String l40_newId = ("v"+runtime.n_i2s.invoke(((Integer)runtime.m_tree.f_sizeTree(arenamings))));
		...
		case 11/*BindMatched*/: {
			...
			final String l47_newId = ("v"+runtime.n_i2s.invoke(((Integer)runtime.m_tree.f_sizeTree(arenamings))));
		...
		case 97/*Seq*/: {
			...
			final Func2<Struct_Pair,Struct_Pair, Struct> l55_$52 = new Func2<Struct_Pair,Struct_Pair,Struct>() {
				final public Struct_Pair invoke(final Struct_Pair aacc, final Struct ap) {
					final Struct_Pair l56_r = f_renameBindingsInParsing(ap, ((Struct)aacc.f_second));
					return (new Struct_Pair(runtime.m_array.f_arrayPush(((Object[])aacc.f_first), l56_r.f_first), l56_r.f_second));
				}
			};
		...
		case 14/*Choices*/: {
			...
			final Func2<Struct_Pair,Struct_Pair, Struct> l62_$59 = new Func2<Struct_Pair,Struct_Pair,Struct>() {
				final public Struct_Pair invoke(final Struct_Pair aacc, final Struct ap) {
					final Struct_Pair l63_r = f_renameBindingsInParsing(ap, ((Struct)aacc.f_second));
					return (new Struct_Pair(runtime.m_array.f_arrayPush(((Object[])aacc.f_first), l63_r.f_first), l63_r.f_second));
				}
			};
