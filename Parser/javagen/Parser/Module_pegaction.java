...
final class Module_pegaction {
	...
	Module_pegaction(Parser runtime) {
	...
	public void init_defaultPegActions() {
		...
		final Func1<Object,Object[]> l2_strUnescape = new Func1<Object,Object[]>() {
			final public Object invoke(final Object[] axs) {
				...
				return runtime.m_dynamic.f_flow(runtime.m_deserialize_string.f_deserializeString((("\""+runtime.n_strReplace.invoke(runtime.m_dynamic.f_flow2s(((Object)(axs[0]))), l3_quote, ("\\"+l3_quote)))+"\"")).f_first);
			}
		};
		...
		final Func1<Object,Object[]> l18_$17 = new Func1<Object,Object[]>() {
			final public Object invoke(final Object[] axs) {
				...
				if ((runtime.h_Native.length(l19_x0)>0)) {
					return ((Object)(l19_x0[0]));
				} else {
					final Object[] l20_a = SingletonStructs.arr_empty;
					return runtime.m_dynamic.f_flow(l20_a);
				}
			}
		};
		...
		final Func1<Object,Object[]> l38_$37 = new Func1<Object,Object[]>() {
			final public Object invoke(final Object[] axs) {
				...
				return runtime.m_dynamic.f_flow(l39_a);
			}
		};
		...
		final Func1<Object,Object[]> l40_$39 = new Func1<Object,Object[]>() {
			final public Object invoke(final Object[] axs) {
				...
				if ((runtime.h_Native.length(l41_x0)>0)) {
