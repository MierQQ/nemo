...
final class Module_pegcode_lib {
	...
	Module_pegcode_lib(Parser runtime) {
	...
	String f_captureEntry2String(Struct ap) {
		...
		case 58/*PegCaptureStringStart*/: {
			...
			return ("stringstart:"+runtime.n_i2s.invoke(((Integer)l3_s)));
		}
		case 95/*RuleResult*/: {
	...
	Object f_evalActionExp(Struct ae, int ai, Struct aenv, Struct afns) {
		...
		case 3/*ActionCallDebug*/: {
			...
			case 39/*None*/: {
				...
				if ((((Struct)runtime.m_dynamic.f_flow(l37_r)).getTypeId() == 22||runtime.m_array.f_contains(l33_vargs, SingletonStructs.str_IllegalStruct))) {
